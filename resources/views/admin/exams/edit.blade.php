...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-0">Edit Exam</h2>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control bg-light border-0 @error('description') is-invalid @enderror" id="description" name="description"
                                rows="4" required>{{ old('description', $exam->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control bg-light border-0 @error('total_questions') is-invalid @enderror"
                                        id="total_questions" name="total_questions" value="{{ old('total_questions', $exam->total_questions) }}" min="1" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control bg-light border-0 @error('passing_percentage') is-invalid @enderror"
                                        id="passing_percentage" name="passing_percentage" value="{{ old('passing_percentage', $exam->passing_percentage) }}" min="1" max="100" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control bg-light border-0 @error('max_attempts') is-invalid @enderror"
                                        id="max_attempts" name="max_attempts" value="{{ old('max_attempts', $exam->max_attempts) }}" min="1" required>
                                </div>
                                @error('max_attempts')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                ...
                <div class="glass-card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" class="form-control bg-light border-0" id="start_date" name="start_date" 
                        ...
                        <div class="mb-2">
                            ...
                            <input type="datetime-local" class="form-control bg-light border-0" id="end_date" name="end_date" 
                ...
                <div class="glass-card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="form-check form-switch mb-3 custom-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="is_published" name="is_published" value="1" {{ old('is_published', $exam->is_published) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3 custom-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="randomize_questions" name="randomize_questions" value="1" {{ old('randomize_questions', $exam->randomize_questions) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-2 custom-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="show_result_immediately" name="show_result_immediately" value="1" {{ old('show_result_immediately', $exam->show_result_immediately) ? 'checked' : '' }}>
